                    ...
                    <?php if (!empty($posts)) { ?>
                        <?php foreach ($posts as $post) { ?>
                            <tr>
                                ...
                                <td> 
                                    <a href="/admin/posts/?act=status&post_id=<?php echo $post['post_id']; ?>&sta=<?php echo ($post['is_active'] == "1") ? "0" : "1"; ?>" title='<?php echo ($post['is_active'] == "1") ? "Active" : "Inactive"; ?>'><i class="glyphicon glyphicon-star <?php echo ($post['is_active'] == "1") ? "" : "grey"; ?>"></i></a> 
                                    <a href="/admin/posts/?act=del&post_id=<?php echo $post['post_id']; ?>" title="Delete"><i class="glyphicon glyphicon-trash"></i></a> 
                                </td>
                            </tr>
                        <?php } ?> 
                    <?php } else { ?>
