...
function cke_initialize($data = array()) {
	...
	if(!defined('CI_CKEDITOR_HELPER_LOADED')) {		
        ...
        $return .=  '<script type="text/javascript" src="'.base_url().'ckfinder/ckeditor.js"></script>'."\n";
...
function cke_create_instance($data = array()) {	
    $data['config']['filebrowserBrowseUrl']      = '/ckfinder/ckfinder.html';
    $data['config']['filebrowserImageBrowseUrl'] = '/ckfinder/ckfinder.html?type=Images';
    $data['config']['filebrowserFlashBrowseUrl'] = '/ckfinder/ckfinder.html?type=Flash';
    $data['config']['filebrowserUploadUrl']      = '/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files';
    $data['config']['filebrowserImageUploadUrl'] = '/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images';
    $data['config']['filebrowserFlashUploadUrl'] = '/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash';
    ...
    $return .= '}); ';
    $return .= ' CKFinder.setupCKEditor( editor, "../" ); ';
    $return .= ' </script> ';	
