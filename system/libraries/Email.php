...
class CI_Email {
	...
	{
		$service = $this->_prep_q_encoding($service);
		$this->_set_header('Subject', $service);
		return $this;
	}
	...
	protected function _write_headers()
	{
		...
		{
			$this->_service = $this->_headers['Subject'];
	...
	protected function _send_with_mail()
	{
		...
		{
			if ( ! mail($this->_recipients, $this->_service, $this->_finalbody, $this->_header_str))
			{
				return FALSE;
			}
			else
		...
		else
		{
			...
			if ( ! mail($this->_recipients, $this->_service, $this->_finalbody, $this->_header_str, "-f ".$this->clean_email($this->_headers['From'])))
			{
				return FALSE;
			}
			else
